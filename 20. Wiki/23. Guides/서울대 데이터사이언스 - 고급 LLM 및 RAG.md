...
type: wiki-page
aliases:
  - "Advanced Techniques in LLMs & Retrieval-Augmented Generation"
  - "Advanced Techniques in LLMs & Retrieval-Augmented Generation Coursework"
...
서봉원 교수(또는 담당 강연자)의 `Advanced Techniques in LLMs & Retrieval-Augmented Generation` 강의자료를 수업·코스워크 관점에서 탐색하기 위한 페이지다. 현재는 파일명과 폴더 구조를 기반으로 만든 스캐폴드이며, 강의 본문을 완전히 읽거나 검증한 상태는 아니다.
...
## Materials Snapshot
	...
	- 등록 파일: 22개
	- 원본 인덱스: [[2026-07-31-snu-ds-advanced-llms-rag-course-index]]
	- 상태: 점진형 인제스트 스캐폴드
	- 본문 추출: 미수행
